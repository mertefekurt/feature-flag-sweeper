...
from feature_flag_sweeper import __version__
from feature_flag_sweeper.core import (
    audit_records,
    read_records,
    render_json,
    render_markdown,
...
from feature_flag_sweeper.rules import PROJECT_NAME


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog='feature-flag-sweeper',
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=Path,
        help='feature flag inventory text or CSV export',
    )
    parser.add_argument(
        "--format",
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"feature-flag-sweeper: error: {exc}", file=sys.stderr)
        return 1
